...
This was not necessary to test the postulates above, but it is good practice to eliminate from consideration any unexpected effects due only to the plasmid.
...
Having collected the bacterial counts for all of these experiments, it now falls to you to carry out the analysis and determine whether the postulates are satisfied. This will tell us whether the _etpD_ gene contributes to adherence.
