...
The motivation of the experiment is to identify candidate adhesion factors in a uropathogenic _Escherichia coli_ (UPEC). UPECs are the most common cause of community-acquired urinary tract infections (UTIs), and infection can cause milder symptoms like discomfort, [polyuria](https://en.wikipedia.org/wiki/Polyuria), and fever, but in some cases can lead to kidney damage, sepsis and death.
